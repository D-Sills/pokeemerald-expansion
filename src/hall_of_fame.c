...
static void Task_Hof_InitTeamSaveData(u8 taskId)
{
    ...
    *lastSavedTeam = *sHofMonPtr;
    ...
    AddTextPrinterParameterized2(0, FONT_NORMAL, gText_SavingDontTurnOffPower, 0, NULL, TEXT_COLOR_WHITE, TEXT_COLOR_DARK_GRAY, TEXT_COLOR_LIGHT_GRAY);
...
static void Task_Hof_WaitAndPrintPlayerInfo(u8 taskId)
{
    ...
    else
    {
        ...
        DrawDialogueFrame(0, FALSE);
        AddTextPrinterParameterized2(0, FONT_NORMAL, gText_LeagueChamp, 0, NULL, TEXT_COLOR_WHITE, TEXT_COLOR_DARK_GRAY, TEXT_COLOR_LIGHT_GRAY);
        CopyWindowToVram(0, COPYWIN_FULL);
...
static void Task_HofPC_PrintDataIsCorrupted(u8 taskId)
{
    ...
    DrawDialogueFrame(0, FALSE);
    AddTextPrinterParameterized2(0, FONT_NORMAL, gText_HOFCorrupted, 0, NULL, TEXT_COLOR_WHITE, TEXT_COLOR_DARK_GRAY, TEXT_COLOR_LIGHT_GRAY);
    CopyWindowToVram(0, COPYWIN_FULL);
