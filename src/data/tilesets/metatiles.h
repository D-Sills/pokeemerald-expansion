...
const u16 gMetatiles_S[] = INCBIN_U16("data/tilesets/primary/s/metatiles.bin");
const u16 gMetatileAttributes_S[] = INCBIN_U16("data/tilesets/primary/s/metatile_attributes.bin");
