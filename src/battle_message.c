...
const u8 gText_MoveInterfacePpType[] = _("{COLOR_HIGHLIGHT_SHADOW DYNAMIC_COLOR4 DYNAMIC_COLOR5 DYNAMIC_COLOR6}PP\nTYPE/");
const u8 gText_MoveInterfaceDynamicColors[] = _("{COLOR_HIGHLIGHT_SHADOW DYNAMIC_COLOR4 DYNAMIC_COLOR5 DYNAMIC_COLOR6}");
const u8 gText_WhichMoveToForget4[] = _("{COLOR_HIGHLIGHT_SHADOW DYNAMIC_COLOR4 DYNAMIC_COLOR5 DYNAMIC_COLOR6}Which move should\nbe forgotten?");
const u8 gText_BattleYesNoChoice[] = _("{COLOR_HIGHLIGHT_SHADOW DYNAMIC_COLOR4 DYNAMIC_COLOR5 DYNAMIC_COLOR6}Yes\nNo");
const u8 gText_BattleSwitchWhich[] = _("{COLOR_HIGHLIGHT_SHADOW DYNAMIC_COLOR4 DYNAMIC_COLOR5 DYNAMIC_COLOR6}Switch\nwhich?");
const u8 gText_BattleSwitchWhich2[] = _("{COLOR_HIGHLIGHT_SHADOW DYNAMIC_COLOR4 DYNAMIC_COLOR5 DYNAMIC_COLOR6}");
...
{
    [B_WIN_MSG] = {
        .fillValue = PIXEL_FILL(FILL_WINDOW_PIXEL),
        .fontId = FONT_NORMAL,
        .x = 0,
        .y = 1,
        .speed = 1,
    ...
    [B_WIN_PP] = {
        ...
        .y = 1,
        .speed = 0,
        .fgColor = B_SHOW_EFFECTIVENESS != SHOW_EFFECTIVENESS_NEVER ? TEXT_COLOR_WHITE : TEXT_COLOR_WHITE,
        .bgColor = FILL_WINDOW_PIXEL,
        .shadowColor = B_SHOW_EFFECTIVENESS != SHOW_EFFECTIVENESS_NEVER ? TEXT_COLOR_LIGHT_GRAY : TEXT_COLOR_LIGHT_GRAY,
    },
    [B_WIN_DUMMY] = {
        .fillValue = PIXEL_FILL(FILL_WINDOW_PIXEL),
        .fontId = FONT_NORMAL,
