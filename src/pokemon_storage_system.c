...
static void Task_PCMainMenu(u8 taskId)
{
    ...
    case STATE_LOAD:
        ...
        AddTextPrinterParameterized2(0, FONT_NORMAL, sMainMenuTexts[task->tSelectedOption].desc, TEXT_SKIP_DRAW, NULL, TEXT_COLOR_WHITE, TEXT_COLOR_DARK_GRAY, TEXT_COLOR_LIGHT_GRAY);
...
static void PrintMessage(u8 id)
{
    ...
    FillWindowPixelBuffer(WIN_MESSAGE, PIXEL_FILL(FILL_WINDOW_PIXEL));
...
static void PrintItemDescription(void)
{
    ...
    FillWindowPixelBuffer(WIN_ITEM_DESC, PIXEL_FILL(FILL_WINDOW_PIXEL));
