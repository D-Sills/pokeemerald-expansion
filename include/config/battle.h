...
#define B_BATTLE_SPEED 0x40F8 // Usage with a variable
...
#define B_ENEMY_MON_SHADOW_STYLE        GEN_2 // In Gen4+, all enemy Pokemon will have a shadow drawn beneath them.
